...
/****** Object:  Database [Tarea3]    Script Date: 07/15/2021 20:25:57 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'Tarea3')
...
/****** Object:  Database [Tarea3]    Script Date: 07/15/2021 18:02:20 ******/
CREATE DATABASE [Tarea3] ON  PRIMARY 
( NAME = N'Tarea3', FILENAME = N'c:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\Tarea3.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Tarea3_log', FILENAME = N'c:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\Tarea3_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Tarea3] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [Tarea3] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Tarea3] SET RECOVERY SIMPLE 
GO
